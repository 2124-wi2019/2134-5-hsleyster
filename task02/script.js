...
*/
convertFrom.addEventListener('select', onSelect);
...
*/
    function onSelect(){
        ...
        if (convertFrom.value.toLowerCaes() == 'kilos'){
...
action.addEventListener('click', afterClick);
    ...
    */
        ...
        const resultText = document.createTextNode(`${userInput} meters is ${resultText} feet`);
        h.value = resultText;
        ...
        const resultText = document.createTextNode(`${userInput} meters is ${resultText} miles`);
        h.value = resultText; 
        h.innerHTML = resultText;
        h.appendChild(resultText);        
        resultHolder.classList.add('visible');
        ...
        const h = document.createElement('h2');
        resultHolder.appendChild(h);
        const resultText = document.createTextNode(`${userInput} liters is ${resultText} gallons`);
        h.value = resultText;
        h.innerHTML = resultText;
        h.appendChild(resultText);
        resultHolder.classList.add('visible');
        ...
        const h = document.createElement('h2');
        resultHolder.appendChild(h);
        const resultText = document.createTextNode(`${userInput} liters is ${resultText} quarts`);
        h.value = resultText;
        h.innerHTML = resultText;
        h.appendChild(resultText);
        resultHolder.classList.add('visible');
        ...
        const h = document.createElement('h2');
        resultHolder.appendChild(h);
        const resultText = document.createTextNode(`${userInput} kilos is ${result} pounds`);
        h.value = resultText;
        h.innerHTML = resultText;
        h.appendChild(resultText);
        resultHolder.classList.add('visible');
        ...
        const h = document.createElement('h2');
        resultHolder.appendChild(h);
        const resultText = document.createTextNode(`${userInput} cesius is ${result} fahrenheit`);
        h.value = resultText;
        h.innerHTML = resultText;
        h.appendChild(resultText);
        resultHolder.classList.add('visible');
